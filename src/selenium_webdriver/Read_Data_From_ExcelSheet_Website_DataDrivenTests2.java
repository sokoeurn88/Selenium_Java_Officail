...
//
//
//public class Read_Data_From_ExcelSheet_Website_DataDrivenTests2 {
...
//			
//			/*1 line statement*/
//			int firstCellValue = (int)current_Row.getCell(0).getNumericCellValue(); /*default value is double, but we don't want it, we want to cast in int value*/
...
//			driver.findElement(By.id("principle")).sendKeys(String.valueOf(firstCellValue));
